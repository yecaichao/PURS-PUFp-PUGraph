...
class SolubilityGN(nn.Module):
    def __init__(self, num_layers, hidden_bias, hidden_node, dropout, aggregation, output_dim=1):
        super().__init__()
        ...
        self.readout_globals = tg.GlobalLinear(output_dim, global_features=hidden_global, bias=True)
